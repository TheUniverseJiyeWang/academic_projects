...
# -*- coding: utf-8 -*-
"""
Created on Sat Aug  3 08:39:34 2019
...
x_train, y_train, _ = get_images("data/fruits-360/Training/*")
x_test, y_test, _ = get_images("data/fruits-360/Validation/*")
...
fig = plt.figure('Predictions on Fruit', facecolor='gray')
